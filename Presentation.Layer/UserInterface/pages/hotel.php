...
<head>
  ...
  <link rel="stylesheet" href="/Travel_Agency/Presentation.Layer/UserInterface/css/hotel.css">
     ...
     <div class="nav-bar">
       ...
       <div class="nav-list">
         <ul>
          ...
          <li><a href="../../../DataAccess.Layer/Config/logout.php" data-after="LogOut">LogOut</a></li>
         </ul>
       </div>
     </div>
   </div>
