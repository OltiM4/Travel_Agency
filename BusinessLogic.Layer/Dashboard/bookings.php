...
if (isset($_GET['delete'])) {
    ...
    if ($deleteQuery) {
        ...
        echo "<script>alert('Error deleting booking: " . addslashes($conn->error) . "');</script>";
    }
}
...
<head>
    ...
    <link rel="stylesheet" href="../../Presentation.Layer/UserInterface/css/bookings.css">
...
<body>
    ...
    <a href="bookings.php?edit=<?= $row['id'] ?>" 
       style="padding:4px 8px; background:#e3f2fd; color:#1976d2; border-radius:3px; text-decoration:none;"
       onmouseover="this.style.filter='brightness(90%)'; this.style.transform='translateY(-1px)'"
       onmouseout="this.style.filter=''; this.style.transform=''">Edit</a>
    <span style="margin:0 4px; color:#e0e0e0">|</span>
    <a href="bookings.php?delete=<?= $row['id'] ?>" 
       style="padding:4px 8px; background:#ffebee; color:#d32f2f; border-radius:3px; text-decoration:none;"
       onmouseover="this.style.filter='brightness(90%)'; this.style.transform='translateY(-1px)'"
       onmouseout="this.style.filter=''; this.style.transform=''">Delete</a>
</td>
                        </tr>
                    <?php } ?>
                </tbody>
