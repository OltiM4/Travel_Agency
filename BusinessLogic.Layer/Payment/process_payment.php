<?php
session_start();
include $_SERVER['DOCUMENT_ROOT'] . '/Travel_Agency/DataAccess.Layer/Config/config.php';
...
<head>
    ...
    <script>
        setTimeout(function() {
            window.location.href = '/Travel_Agency/Presentation.Layer/UserInterface/pages/afterlogin.php'; 
        }, 3000);
    </script>
    <?php endif; ?>
</head>
